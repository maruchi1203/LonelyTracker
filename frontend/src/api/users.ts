import type { OpenAiKeyStatus, UserResponse, UserSettings } from '../types/schedule'
...
/** 바뀐 설정을 그대로 돌려준다 */
export async function changeSettings(settings: UserSettings): Promise<UserSettings> {
