package com.lonelytracker.backend.schedule.spec;
...
public final class ScheduleSpecs {
    ...
    public static Specification<Schedule> startAtFrom(LocalDateTime from) {
        return (root, query, cb) ->
                from == null ? null : cb.greaterThanOrEqualTo(root.get("startAt"), from);
    }

    public static Specification<Schedule> startAtTo(LocalDateTime to) {
        return (root, query, cb) ->
     ...
     */
    public static Specification<Schedule> hasCategory(String category) {
        return (root, query, cb) -> {
